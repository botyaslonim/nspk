...
angular.
   module("register3").
   component("register3", {
      templateUrl: "tables/table7/files/register3/register3.template.html",
      controller: ["$http", "$scope", "$routeParams", "$timeout", "$window", "popup", "parseDoc", "sort", "header", "ids", "requests",
      	function Register3Controller($http, $scope, $routeParams, $timeout, $window, popup, parseDoc, sort, header, ids, requests) {
